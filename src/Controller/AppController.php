    ...
    public function initialize()
    {
        ...
        switch ($this->request->getParam('prefix')) {
            ...
            $this->loadComponent('Auth', [
                ...
                $this->Auth->allow(['signup','productdetails','createorder' ,'forgot', 'login', 'passwordreset', 'verifyaccount','staticpage','getcategories','getproducts','enquiry','getnavigation','completeorder','token','logout']);
