<?php
namespace CatalogManager\Test\Fixture;
 ...
 *
 */
class OptionValuesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'option_id' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'BY_OPTION_ID' => ['type' => 'index', 'columns' => ['option_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            'id' => 1,
            'option_id' => 'Lorem ipsum dolor ',
            'title' => 'Lorem ipsum dolor sit amet',
            'image' => 'Lorem ipsum dolor sit amet',
            'sort_order' => 1,
            'created' => '2018-02-02 08:59:51',
            'modified' => '2018-02-02 08:59:51'
        ],
    ];
}
