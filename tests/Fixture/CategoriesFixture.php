...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'short_description' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'sort_order' => 1,
                'status' => 1,
                'created' => '2021-03-01 19:24:14',
                'modified' => '2021-03-01 19:24:14'
            ],
        ];
        parent::init();
    }
