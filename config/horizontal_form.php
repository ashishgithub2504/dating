...
return $myTemplates = [
            ...
            'checkbox' => '<div class="col-md-3"><input type="checkbox" name="{{name}}" value="{{value}}"{{attrs}}></div>',
            'checkboxFormGroup' => '{{label}}',
            'checkboxWrapper' => '<div class="checkbox">{{label}}</div>',
            'dateWidget' => '{{year}}{{month}}{{day}}{{hour}}{{minute}}{{second}}{{meridian}}',
            'error' => '<div class="col-md-offset-2 col-md-8 error-message text-danger">{{content}}</div>',
